...
function SidebarMaterial(editor) {
  ...
  materialSlotRow.add(
    new UIText(strings.getKey("sidebar/material/slot")).setWidth("90px")
  );

  var materialSlotSelect = new UISelect()
    .setWidth("170px")
    .setFontSize("12px")
    .onChange(update);
  ...
  var materialClass = new UISelect()
    .setWidth("150px")
    .setFontSize("12px")
    .onChange(update);

  materialClassRow.add(
    new UIText(strings.getKey("sidebar/material/type")).setWidth("90px")
  );
  ...
  var materialUUID = new UIInput()
    .setWidth("102px")
    .setFontSize("12px")
    .setDisabled(true);
  var materialUUIDRenew = new UIButton(strings.getKey("sidebar/material/new"))
    .setMarginLeft("7px")
    .onClick(function () {
  ...
  materialUUIDRow.add(
    new UIText(strings.getKey("sidebar/material/uuid")).setWidth("90px")
  );
  ...
  materialNameRow.add(
    new UIText(strings.getKey("sidebar/material/name")).setWidth("90px")
  );
  ...
  materialProgramRow.add(
    new UIText(strings.getKey("sidebar/material/program")).setWidth("90px")
  );

  var materialProgramInfo = new UIButton(
    strings.getKey("sidebar/material/info")
  );
  ...
  var materialProgramVertex = new UIButton(
    strings.getKey("sidebar/material/vertex")
  );
  ...
  var materialProgramFragment = new UIButton(
    strings.getKey("sidebar/material/fragment")
  );
  ...
  materialColorRow.add(
    new UIText(strings.getKey("sidebar/material/color")).setWidth("90px")
  );
  ...
  var materialRoughness = new UINumber(0.5)
    .setWidth("60px")
    .setRange(0, 1)
    .onChange(update);

  materialRoughnessRow.add(
    new UIText(strings.getKey("sidebar/material/roughness")).setWidth("90px")
  );
  ...
  var materialMetalness = new UINumber(0.5)
    .setWidth("60px")
    .setRange(0, 1)
    .onChange(update);

  materialMetalnessRow.add(
    new UIText(strings.getKey("sidebar/material/metalness")).setWidth("90px")
  );
  ...
  var materialTransmission = new UINumber(1)
    .setWidth("30px")
    .setRange(0, 1)
    .onChange(update);

  materialTransmissionRow.add(
    new UIText(strings.getKey("sidebar/material/transmission")).setWidth("90px")
  );
  ...
  var materialEmissiveIntensity = new UINumber(1)
    .setWidth("30px")
    .onChange(update);

  materialEmissiveRow.add(
    new UIText(strings.getKey("sidebar/material/emissive")).setWidth("90px")
  );
  ...
  materialSpecularRow.add(
    new UIText(strings.getKey("sidebar/material/specular")).setWidth("90px")
  );
  ...
  materialShininessRow.add(
    new UIText(strings.getKey("sidebar/material/shininess")).setWidth("90px")
  );
  ...
  var materialClearcoat = new UINumber(1)
    .setWidth("60px")
    .setRange(0, 1)
    .onChange(update);

  materialClearcoatRow.add(
    new UIText(strings.getKey("sidebar/material/clearcoat")).setWidth("90px")
  );
  ...
  var materialClearcoatRoughness = new UINumber(1)
    .setWidth("60px")
    .setRange(0, 1)
    .onChange(update);

  materialClearcoatRoughnessRow.add(
    new UIText(strings.getKey("sidebar/material/clearcoatroughness")).setWidth(
      "90px"
    )
  );
  ...
  materialVertexColorsRow.add(
    new UIText(strings.getKey("sidebar/material/vertexcolors")).setWidth("90px")
  );
  ...
  materialVertexTangentsRow.add(
    new UIText(strings.getKey("sidebar/material/vertextangents")).setWidth(
      "90px"
    )
  );
  ...
  materialDepthPackingRow.add(
    new UIText(strings.getKey("sidebar/material/depthPacking")).setWidth("90px")
  );
  ...
  materialMapRow.add(
    new UIText(strings.getKey("sidebar/material/map")).setWidth("90px")
  );
  ...
  materialMatcapMapRow.add(
    new UIText(strings.getKey("sidebar/material/matcap")).setWidth("90px")
  );
  ...
  materialAlphaMapRow.add(
    new UIText(strings.getKey("sidebar/material/alphamap")).setWidth("90px")
  );
  ...
  materialBumpMapRow.add(
    new UIText(strings.getKey("sidebar/material/bumpmap")).setWidth("90px")
  );
  ...
  materialNormalMapRow.add(
    new UIText(strings.getKey("sidebar/material/normalmap")).setWidth("90px")
  );
  ...
  var materialClearcoatNormalMapEnabled = new UICheckbox(false).onChange(
    update
  );
  var materialClearcoatNormalMap = new UITexture().onChange(update);
  var materialClearcoatNormalScaleX = new UINumber(1)
    .setWidth("30px")
    .onChange(update);
  var materialClearcoatNormalScaleY = new UINumber(1)
    .setWidth("30px")
    .onChange(update);

  materialClearcoatNormalMapRow.add(
    new UIText(strings.getKey("sidebar/material/clearcoatnormalmap")).setWidth(
      "90px"
    )
  );
  ...
  var materialDisplacementScale = new UINumber(1)
    .setWidth("30px")
    .onChange(update);

  materialDisplacementMapRow.add(
    new UIText(strings.getKey("sidebar/material/displacemap")).setWidth("90px")
  );
  ...
  materialRoughnessMapRow.add(
    new UIText(strings.getKey("sidebar/material/roughmap")).setWidth("90px")
  );
  ...
  materialMetalnessMapRow.add(
    new UIText(strings.getKey("sidebar/material/metalmap")).setWidth("90px")
  );
  ...
  materialSpecularMapRow.add(
    new UIText(strings.getKey("sidebar/material/specularmap")).setWidth("90px")
  );
  ...
  var materialEnvMap = new UITexture(
    THREE.EquirectangularReflectionMapping
  ).onChange(updateMaterial);
  var materialReflectivity = new UINumber(1).setWidth("30px").onChange(update);

  materialEnvMapRow.add(
    new UIText(strings.getKey("sidebar/material/envmap")).setWidth("90px")
  );
  ...
  materialLightMapRow.add(
    new UIText(strings.getKey("sidebar/material/lightmap")).setWidth("90px")
  );
  ...
  var materialAOScale = new UINumber(1)
    .setRange(0, 1)
    .setWidth("30px")
    .onChange(update);

  materialAOMapRow.add(
    new UIText(strings.getKey("sidebar/material/aomap")).setWidth("90px")
  );
  ...
  materialEmissiveMapRow.add(
    new UIText(strings.getKey("sidebar/material/emissivemap")).setWidth("90px")
  );
  ...
  materialGradientMapRow.add(
    new UIText(strings.getKey("sidebar/material/gradientmap")).setWidth("90px")
  );
  ...
  materialSideRow.add(
    new UIText(strings.getKey("sidebar/material/side")).setWidth("90px")
  );
  ...
  var materialSize = new UINumber(1)
    .setWidth("60px")
    .setRange(0, Infinity)
    .onChange(update);

  materialSizeRow.add(
    new UIText(strings.getKey("sidebar/material/size")).setWidth("90px")
  );
  ...
  materialSizeAttenuationRow.add(
    new UIText(strings.getKey("sidebar/material/sizeAttenuation")).setWidth(
      "90px"
    )
  );
  ...
  materialShadingRow.add(
    new UIText(strings.getKey("sidebar/material/flatshaded")).setWidth("90px")
  );
  ...
  var materialBlending = new UISelect()
    .setOptions({
  ...
  materialBlendingRow.add(
    new UIText(strings.getKey("sidebar/material/blending")).setWidth("90px")
  );
  ...
  var materialOpacity = new UINumber(1)
    .setWidth("60px")
    .setRange(0, 1)
    .onChange(update);

  materialOpacityRow.add(
    new UIText(strings.getKey("sidebar/material/opacity")).setWidth("90px")
  );
  ...
  materialTransparentRow.add(
    new UIText(strings.getKey("sidebar/material/transparent")).setWidth("90px")
  );
  ...
  var materialAlphaTest = new UINumber()
    .setWidth("60px")
    .setRange(0, 1)
    .onChange(update);

  materialAlphaTestRow.add(
    new UIText(strings.getKey("sidebar/material/alphatest")).setWidth("90px")
  );
  ...
  materialDepthTestRow.add(
    new UIText(strings.getKey("sidebar/material/depthtest")).setWidth("90px")
  );
  ...
  materialDepthWriteRow.add(
    new UIText(strings.getKey("sidebar/material/depthwrite")).setWidth("90px")
  );
  ...
  materialWireframeRow.add(
    new UIText(strings.getKey("sidebar/material/wireframe")).setWidth("90px")
  );
  ...
  function update() {
    ...
    if (material) {
      ...
      if (
        ...
        material.color.getHex() !== materialColor.getHexValue()
      ) {
        editor.execute(
      ...
      if (
        ...
        Math.abs(material.roughness - materialRoughness.getValue()) >= epsilon
      ) {
        editor.execute(
          new SetMaterialValueCommand(
            editor,
      ...
      if (
        ...
        Math.abs(material.metalness - materialMetalness.getValue()) >= epsilon
      ) {
        editor.execute(
          new SetMaterialValueCommand(
            editor,
      ...
      if (
        ...
        Math.abs(material.transmission - materialTransmission.getValue()) >=
          epsilon
      ) {
        editor.execute(
          new SetMaterialValueCommand(
      ...
      if (
        ...
        material.emissive.getHex() !== materialEmissive.getHexValue()
      ) {
        editor.execute(
          new SetMaterialColorCommand(
            editor,
      ...
      if (
        ...
        material.emissiveIntensity !== materialEmissiveIntensity.getValue()
      ) {
        editor.execute(
          new SetMaterialValueCommand(
            editor,
            currentObject,
            "emissiveIntensity",
            materialEmissiveIntensity.getValue(),
            currentMaterialSlot
          )
        );
      }
      ...
      if (
        ...
        material.specular.getHex() !== materialSpecular.getHexValue()
      ) {
        editor.execute(
          new SetMaterialColorCommand(
            editor,
      ...
      if (
        ...
        Math.abs(material.shininess - materialShininess.getValue()) >= epsilon
      ) {
        editor.execute(
          new SetMaterialValueCommand(
            editor,
      ...
      if (
        ...
        Math.abs(material.clearcoat - materialClearcoat.getValue()) >= epsilon
      ) {
        editor.execute(
          new SetMaterialValueCommand(
            editor,
      ...
      if (
        ...
        Math.abs(
          material.clearcoatRoughness - materialClearcoatRoughness.getValue()
        ) >= epsilon
      ) {
        editor.execute(
          new SetMaterialValueCommand(
            ...
            currentObject,
            "clearcoatRoughness",
            materialClearcoatRoughness.getValue(),
            currentMaterialSlot
          )
        );
      }
      ...
      if (material.normalMap !== undefined) {
        ...
        if (objectHasUvs) {
          var normalMap = normalMapEnabled
            ? materialNormalMap.getValue()
            : null;
          ...
          if (
            material.normalScale.x !== materialNormalScaleX.getValue() ||
      ...
      if (material.clearcoatNormalMap !== undefined) {
        var clearcoatNormalMapEnabled =
          materialClearcoatNormalMapEnabled.getValue() === true;

        if (objectHasUvs) {
          var clearcoatNormalMap = clearcoatNormalMapEnabled
            ? materialClearcoatNormalMap.getValue()
            : null;
          ...
          if (
            material.clearcoatNormalScale.x !==
      ...
      if (material.displacementMap !== undefined) {
        var displacementMapEnabled =
          materialDisplacementMapEnabled.getValue() === true;

        if (objectHasUvs) {
          var displacementMap = displacementMapEnabled
            ? materialDisplacementMap.getValue()
            : null;
          ...
          if (
            ...
            editor.execute(
              new SetMaterialValueCommand(
                ...
                currentObject,
                "displacementScale",
                materialDisplacementScale.getValue(),
                currentMaterialSlot
              )
            );
          }
      ...
      if (material.roughnessMap !== undefined) {
        var roughnessMapEnabled =
          materialRoughnessMapEnabled.getValue() === true;

        if (objectHasUvs) {
          var roughnessMap = roughnessMapEnabled
            ? materialRoughnessMap.getValue()
            : null;
      ...
      if (material.metalnessMap !== undefined) {
        var metalnessMapEnabled =
          materialMetalnessMapEnabled.getValue() === true;

        if (objectHasUvs) {
          var metalnessMap = metalnessMapEnabled
      ...
      if (material.specularMap !== undefined) {
        ...
        if (objectHasUvs) {
          var specularMap = specularMapEnabled
            ? materialSpecularMap.getValue()
            : null;
      ...
      if (material.emissiveMap !== undefined) {
        ...
        if (objectHasUvs) {
          var emissiveMap = emissiveMapEnabled
            ? materialEmissiveMap.getValue()
            : null;
      ...
      if (material.gradientMap !== undefined) {
        ...
        var gradientMap = gradientMapEnabled
          ? materialGradientMap.getValue()
          : null;
      ...
      if (
        ...
        Math.abs(material.opacity - materialOpacity.getValue()) >= epsilon
      ) {
        editor.execute(
          new SetMaterialValueCommand(
            editor,
      ...
      if (
        ...
        Math.abs(material.alphaTest - materialAlphaTest.getValue()) >= epsilon
      ) {
        editor.execute(
          new SetMaterialValueCommand(
            editor,
      ...
      if (
        ...
        material.depthTest !== materialDepthTest.getValue()
      ) {
        editor.execute(
          new SetMaterialValueCommand(
            editor,
      ...
      if (
        ...
        material.depthWrite !== materialDepthWrite.getValue()
      ) {
        editor.execute(
          new SetMaterialValueCommand(
            editor,
  ...
  function setRowVisibility() {
    ...
    for (var property in properties) {
      properties[property].setDisplay(
        material[property] !== undefined ? "" : "none"
      );
    }
  }
  ...
  function refreshUI(resetTextureSelectors) {
    ...
    if (material.clearcoatNormalMap !== undefined) {
      materialClearcoatNormalMapEnabled.setValue(
    ...
    if (material.displacementMap !== undefined) {
      materialDisplacementMapEnabled.setValue(
